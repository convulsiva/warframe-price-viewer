...
WFMarketTracker — это desktop-приложение для быстрого просмотра цен на предметы Warframe через данные warframe.market.
...
1. Скачай `.dmg`.
2. Открой файл.
3. Перетащи `WFMarketTracker.app` в Applications.
...
4. После установки открой WFMarketTracker.
...
WFMarketTracker is a desktop app for checking Warframe item prices using warframe.market data.
...
1. Download the `.dmg`.
2. Open it.
3. Drag `WFMarketTracker.app` into Applications.
4. Launch the app.
...
4. Open WFMarketTracker after installation.
